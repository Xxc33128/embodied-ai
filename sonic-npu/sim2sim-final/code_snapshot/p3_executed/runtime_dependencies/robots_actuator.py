...
class DelayedImplicitActuator(ImplicitActuator):
    ...
    def compute(
        ...
        # print('DelayedImplicitActuatorCfg compute')
        if torch.isnan(control_action.joint_positions).any():
        ...
        assert not torch.isnan(control_action.joint_positions).any(), "DelayedImplicitActuator NaN correction failed!"
        assert not torch.isinf(control_action.joint_positions).any(), (
            "DelayedImplicitActuator self.actions_after_delay contain Inf!"
        )
