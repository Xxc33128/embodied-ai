...
| 路径 | 内容 | 说明 |
|---|---|---|
| `00_总览.md` + 三份主报告 + `SONIC_三输入到29维动作_神经网络层级图_v2.png` | 报告套件（同目录互链） | ② 原版解析 v1.7 / ③ 分支审计 v1.4 / ① B 路线报告 v1.4 |
| `lectures/` | 讲解提纲 + 3 份讲稿 | 版本对应关系见 `lectures/README.md` |
| `survey/` | SONIC 与具身智能技术综述 | 2026-08-20 知识底稿，独立成篇 |
| `worklog/` | 10 个里程碑工作文档 | Sim2Sim 审查链的关键节点（母计划/权威数字/各阶段验收终章）；完整 25 环审查链存于本地工作区，未上传 |
| `env-docs/` | 环境排障复盘、综合进展报告、周报 ×2 | 排障复盘副本已删除泄露 PAT 断片（原件仍含，本地保存） |
...
- 本目录为 2026-09-08 快照；主报告后续修订以各文件头部版本号为准。
