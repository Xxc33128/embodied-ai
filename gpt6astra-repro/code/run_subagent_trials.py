...
def run_trial(args):
    ...
    try:
        ...
        task=Task(name='robosuite-bowl-gpt6-subagent',scenes=[Scene(id=f'seed-{scene_seed}',
        ...
        policy=StandardPolicy(model='gpt-6-astra',base_url='http://subagent-relay.invalid/v1',
        ...
        outcome={'status':log.status,'metrics':dict(log.results.metrics),
                 ...
                 'source':'gpt-6-astra persistent trial subagent via LLMAgentPolicy transport',
