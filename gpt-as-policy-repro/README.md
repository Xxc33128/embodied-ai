...
> **2026-09-21 同环境复现入口：** [项目 Wiki](https://github.com/Xxc33128/embodied-ai/wiki) / [完整性检查](docs/wiki/Audit.md)。已补入昨天实际 runner、转换脚本和运行补丁；Mac 监听程序已补写；新服务器仍须准备镜像、权重与场景文件，见 Wiki 的服务器迁移页。下文旧阶段记录不代表完整交付。
