# # 原实现 vendored（逐字复制），来源 commit 8f3d362b… 的
# # hybrid_rollout/robodojo/robodojo_server/action_edit_kinematics.py。
"""原实现 vendored（只改相对 import），来源 commit 8f3d362b… 的
hybrid_rollout/robodojo/robodojo_server/action_edit_kinematics.py。逐字复制。"""
