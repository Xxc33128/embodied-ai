...
def main():
    ...
    ap.add_argument("--benchmark", default="libero_goal_swap")
    ...
    if args.benchmark != "libero_goal_swap" or args.condition != "Pos":
        raise ValueError("This run requires LIBERO-PRO Pos: libero_goal_swap")
    ...
    case = CaseSpec.from_inventory(row, campaign_id=root.name,
                                  episode_id=f"goal0-pos-init0-600-{args.method}",
    ...
    try:
        ...
        ori = next(r for r in rows if r["benchmark"] == 'libero_goal'
