...
def main():
    ...
    ap.add_argument("--benchmark", default="libero_object_swap")
    ...
    if args.benchmark != "libero_object_swap" or args.condition != "Pos":
        raise ValueError("This run requires LIBERO-PRO Pos: libero_object_swap")
    row = next(r for r in rows if r["benchmark"] == args.benchmark
               and r["condition"] == args.condition and r["task_index"] == 5)
    ...
    try:
        ...
        ori = next(r for r in rows if r["benchmark"] == "libero_object"
