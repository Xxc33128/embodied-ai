...
| 日期 | 文档 | 结论 |
|---|---|---|
| 9/17 | [图像空间与深度理解后训练生态调研](2026-09-17-图像空间与深度理解后训练生态调研.md) | v1.2：核对核心论文与官方文档（E3，未做源码审计/训练复现）；纠正 SD-VLM 编号与机制、InternSpatial 规模等问题；区分 SFT、奖励/偏好优化、几何增强与动作迁移，补充数据选择、NPU 验证条件及实验对照；未核读线索单列。 |
